...
- Click the micro:bit's B button to enable I^2^C handler mode. The Tetrapad should stop responding to touch input.
- Click the micro:bit's A button to begin streaming over I<sup>2</sup>C. Shake to your heart's content.
